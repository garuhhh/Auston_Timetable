...
public class ListofProgrammes {
	...
	public static void main(String[] args) {
		...
		shlAustonTimetable.setImage(SWTResourceManager.getImage(ListofProgrammes.class, "/com/sun/java/swing/plaf/windows/icons/JavaCup32.png"));
		...
		shlAustonTimetable.setText("List of Programmes and Universities");
