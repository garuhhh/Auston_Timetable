...
public class RoomUtilization {
	...
	public static void main(String[] args) {
		...
		shlAustonTimetable.setImage(SWTResourceManager.getImage(RoomUtilization.class, "/com/sun/java/swing/plaf/windows/icons/JavaCup32.png"));
		...
		shlAustonTimetable.setText("Room Utilization");
